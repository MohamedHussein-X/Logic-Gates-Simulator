...
D_OR_G::D_OR_G(ApplicationManager* pApp) :Action(pApp)
{
}
...
void D_OR_G::ReadActionParameters()
{
...
bool D_OR_G::Execute()
{
	...
	if (D_OR_G::ValidDarwingArea()) {
		GraphicsInfo GInfo; //Gfx info to be used to construct the AND2 gate
		GInfo.x1 = Cx - Len / 2;
		GInfo.x2 = Cx + Len / 2;
		GInfo.y1 = Cy - Wdth / 2;
		GInfo.y2 = Cy + Wdth / 2;
		OR* pA = new OR(GInfo, OR_FANOUT);
